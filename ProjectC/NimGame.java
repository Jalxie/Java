...
public class NimGame
{
	...
	public String startgame(String[] subCommand, NimPlayer[] Players)
	{
		...
		int stoneRemoval = 0;
		int index1 = nim.playerIndex(subCommand, Players, FIRST_PLAYER);
		int index2 = nim.playerIndex(subCommand, Players, SECOND_PLAYER);
		...
		while(currentStoneCount >= ZERO)
		{
			...
			stoneRemoval = Players[index1].removeStone(upperBound, currentStoneCount);
			System.out.println();
			//Game playing
			...
			stoneRemoval = Players[index2].removeStone(upperBound, currentStoneCount);
			System.out.println();
			currentStoneCount  = gamePlay(currentStoneCount , upperBound, stoneRemoval,
										 Name2, Name1);
		}
